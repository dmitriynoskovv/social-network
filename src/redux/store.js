...
// reducer - чистая функция, которая принимает части state и action применяет и возвращает либо новый state
// либо возвращает его неизменнным, если требуется (они же кусочки dispatch)
